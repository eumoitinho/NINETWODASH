            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                <li>
                  <Link
                    href='/dashboards'
                    className={pathname === "/dashboards" ? "active-page" : ""}
                  >
                ...
                <li>
                  <Link
                    ...
                    className={pathname === "/dashboard-overview" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-info-main w-auto' />{" "}
                    Visão Geral
                  </Link>
            ...
            <li className='dropdown'>
              ...
              <ul className='sidebar-submenu'>
                ...
                <li>
                  <Link
                    href='/add-client'
                    className={pathname === "/add-client" ? "active-page" : ""}
                  >
                    <i className='ri-circle-fill circle-icon text-success-main w-auto' />{" "}
                    Adicionar Cliente
                  </Link>
                ...
                <li>
                  <Link
                    href='/client-tags'
                    className={pathname === "/client-tags" ? "active-page" : ""}
                  >
                ...
                <li>
                  <Link
                    href='/budgets'
                    className={pathname === "/budgets" ? "active-page" : ""}
                  >
